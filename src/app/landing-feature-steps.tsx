...
import { Rocket, BrainCircuit, MessageSquare, FileText } from 'lucide-react';
   ...
   useEffect(() => {
    const timer = setInterval(() => {
      setProgress((prevProgress) => {
        ...
        return prevProgress + 100 / (4000 / 100);
      });
    }, 100);
        ...
        <hr className="bg-foreground/30 mx-auto mb-10 h-px w-1/2" />
         ...
         <div className="flex flex-col gap-6 md:grid md:grid-cols-2 md:gap-10">
          <div className="order-2 space-y-8 md:order-1">
           ...
           <div
            className={cn(
              'border-primary/20 relative order-1 h-[200px] overflow-hidden rounded-xl border [box-shadow:0_5px_30px_-15px_rgba(192,15,102,0.3)] md:order-2 md:h-auto',
            )}
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 h-4 bg-transparent border-t border-border">
                <motion.div 

  ...
  return (
    <section className="bg-background relative w-full overflow-hidden py-16 md:py-24">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="border-border/40 bg-secondary/20 mx-auto max-w-4xl overflow-hidden rounded-[28px] border shadow-xl backdrop-blur-sm">
          <div className="p-6 md:p-10" ref={formRef}>
            <motion.div
              ...
              className="flex w-full gap-2 text-center flex-col items-center"
            >
              ...
              <div className="relative">
                <p className="text-primary relative z-10 w-full text-lg font-medium tracking-tight italic md:text-xl">

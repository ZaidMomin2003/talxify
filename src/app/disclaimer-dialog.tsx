...
import { BrainCircuit, Code, Copy, Swords, BookOpen, FileText, User, Gem, MessageSquare } from 'lucide-react';
import { Badge } from '@/components/ui/badge';


const features = [
  { icon: BrainCircuit, title: 'AI Interview Question Bank', description: 'Generate questions for any role, tailored to your needs.' },
  { icon: MessageSquare, title: 'AI Mock Interviews', description: 'Practice with a realistic AI that asks relevant questions.' },
  { icon: Code, title: 'AI Coding Gym', description: 'Solve problems with instant, line-by-line feedback.' },
...
export default function PromotionalPopup() {
  ...
  useEffect(() => {
    ...
    // Only show the promo on the landing page ('/'), if not logged in, and if hasn't seen before

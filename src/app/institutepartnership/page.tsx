                ...
                <section>
                    <div className="text-center mb-12">
                        ...
                        <div className="prose prose-lg dark:prose-invert max-w-3xl mx-auto text-left mt-8">
                            <p>
                                Moving from college to a tech career is full of challenges, especially during the pressure of technical interviews. From thousands of our AI-led practice sessions, we see the same problems pop up again and again. A huge <strong>70% of students</strong> find it hard to explain what they're thinking, which hurts their confidence during the rest of the interview. This isn’t just about speaking smoothly; it's about being unable to explain technical choices when the pressure is on. In coding tests, over <strong>60% of first tries</strong> fail because students don’t think about tricky inputs, and just as many offer slow, simple solutions without thinking about how efficient they are—a big warning sign for interviewers.
                            </p>
                            <p>
                                On top of that, a massive <strong>85% of student portfolios</strong> don't have exciting project descriptions or clear results, so they don't make a good first impression. This all comes down to a lack of the right kind of practice. Without regular, focused training that feels like a real interview, students are often unprepared to apply their knowledge and communicate their skills. They might know the theory, but they haven’t built the "muscle memory" for performing well in an interview. This is the exact gap Talxify was built to fill—turning classroom knowledge into real-world, interview-ready skills.
                            </p>
                            <p className="mt-6 text-sm text-muted-foreground">
                                For further reading on these topics, explore these articles:
                                <ul className="list-disc pl-5">
                                    <li><a href="https://www.forbes.com/sites/forbestechcouncil/2023/03/27/the-tech-skills-gap-is-widening-how-can-businesses-bridge-it/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Forbes: The Tech Skills Gap Is Widening</a></li>
                                    <li><a href="https://timesofindia.indiatimes.com/blogs/voices/the-great-indian-employability-crisis-bridging-the-gap-between-education-and-industry/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Times of India: The Great Indian Employability Crisis</a></li>
                                </ul>
                            </p>
                        </div>
                    </div>

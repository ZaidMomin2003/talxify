          ...
          <div className="w-full lg:w-auto">
            ...
            <motion.div variants={itemVariants} className="mb-8 flex flex-wrap items-center justify-center gap-2 lg:justify-start">
              <span className="text-xs font-medium text-gray-400">Powered by:</span>
                ...
                <div className="flex items-center gap-1 text-sm"><div className="w-2 h-2 rounded-full bg-green-400"/>VideoSDK</div>
                <div className="flex items-center gap-1 text-sm"><div className="w-2 h-2 rounded-full bg-purple-400"/>Cloudinary</div>

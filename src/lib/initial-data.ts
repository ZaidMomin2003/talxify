...
export const initialPortfolioData: Omit<UserData, 'activity' | 'subscription' | 'onboardingCompleted' | 'syllabus' | 'id'> = {
    portfolio: {
        ...
        faqs: [{ question: 'What are you most passionate about in software development?', answer: 'I am most passionate about creating elegant solutions to complete problems and building products that have a meaningful impact on people\'s lives. I love the blend of creativity and logic that software engineering requires.' }],
        hobbies: [],
    },
    todos: [],
};
